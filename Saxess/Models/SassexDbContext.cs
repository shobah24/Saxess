...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AppointmentId).HasName("PK__Appointm__8ECDFCA281C0B02E");
        ...
        {
            entity.HasKey(e => e.CustomerId).HasName("PK__Customer__A4AE64B80705EDD1");
        ...
        {
            entity.HasKey(e => e.EmployeeId).HasName("PK__Employee__7AD04FF1C60C46B1");
            ...
            entity.HasMany(d => d.Treatments).WithMany(p => p.Employees)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    l => l.HasOne<Employee>().WithMany()
                        ...
                        .OnDelete(DeleteBehavior.ClientSetNull)
                        .HasConstraintName("FK__Employees__Emplo__5441852A"),
                    j =>
                    {
                        j.HasKey("EmployeeId", "TreatmentId").HasName("PK__Employee__7B75348053093012");
        ...
        {
            entity.HasKey(e => e.TreatmentId).HasName("PK__Treatmen__1A57B71195727BCE");
